...
int  sum (int count,...) {
    ...
    va_list array ; // macro function to create array of the i/p parameters
    va_start(array, count);// macro takes (array of parameter ,  number of them)
    
    for (int i = 0; i <count ; i++) {
        int num = va_arg(array , int); // macro takes (array of parameter , type return the parameter)
        sum+=num;
    } 
    va_end(array);
    return sum;
